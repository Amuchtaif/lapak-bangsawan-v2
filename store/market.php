            ...
            <div class="flex items-center justify-between gap-4 md:gap-8">
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    <nav class="hidden md:flex items-center gap-6 mr-4">
                        ...
                        <a class="text-sm font-medium text-primary" href="market.php">Belanja</a>
                        <a class="text-sm font-medium hover:text-primary transition-colors" href="about.php">Tentang
                            Kami</a>
                    </nav>
                    <a href="cart.php"
                        ...
                        <?php while ($bs_product = mysqli_fetch_assoc($best_sellers)):
                            ...
                            <article
                                ...
                                <div class="relative h-32 sm:h-48 overflow-hidden rounded-t-xl bg-slate-100">
                                    <?php if ($bs_product['image']): ?>
                                        <img alt="<?php echo htmlspecialchars($bs_product['name']); ?>"
                                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                                            src="<?php echo htmlspecialchars($bs_product['image']); ?>" />
                                    <?php else: ?>
