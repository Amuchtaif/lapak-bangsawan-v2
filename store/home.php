                        ...
                        <div class="flex items-center justify-end gap-4 lg:gap-8">
                            <nav class="hidden lg:flex items-center gap-6">
                                ...
                                <a class="text-[#111318] dark:text-white text-sm font-medium hover:text-primary transition-colors"
                                    href="market.php">Belanja</a>
                                <a class="text-[#111318] dark:text-white text-sm font-medium hover:text-primary transition-colors"
                                    href="about.php">Tentang Kami</a>
                            </nav>
                ...
                <div class="py-8 mt-8">
                    <div class="flex items-center justify-between mb-6">
                        <h2
                            ...
                            Kategori Kami</h2>
                        <a class="text-primary text-sm font-semibold hover:underline" href="market.php">Lihat
                            Semua</a>
                    </div>
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div
                            ...
                            <div class="w-full aspect-square bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
                                ...
                                style='background-image: url("assets/images/daging ayam.jpg");'>
                            </div>
                        ...
                        <div
                            ...
                            <div class="w-full aspect-square bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
                                ...
                                style='background-image: url("assets/images/pala-ayam.jpg");'>
                            </div>
                            <div class="p-4 flex flex-col gap-2">
                                <div class="flex justify-between items-start">
                                    <h3
                        ...
                        <div
                            class="flex flex-col gap-3 rounded-xl border border-[#dbdfe6] dark:border-[#2d3748] bg-white dark:bg-[#1a202c] p-0 overflow-hidden group hover:shadow-lg transition-all">
                            <div class="w-full aspect-square bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
                                data-alt="Large tiger prawns" style='background-image: url("assets/images/tuna.jpg");'>
                            </div>
                            <div class="p-4 flex flex-col gap-2">
                                <div class="flex justify-between items-start">
                                    <h3
                        ...
                        <div
                            ...
                            <div class="w-full aspect-square bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
                                ...
                                style='background-image: url("assets/images/seafood.jpg");'>
                            </div>
                            <div class="p-4 flex flex-col gap-2">
                                <div class="flex justify-between items-start">
                                    <h3
